...
class FilterPenerimaanDialog extends StatefulWidget {
  ...
  @override
  State<FilterPenerimaanDialog> createState() => _FilterPenerimaanDialogState();
}

class _FilterPenerimaanDialogState extends State<FilterPenerimaanDialog> {
